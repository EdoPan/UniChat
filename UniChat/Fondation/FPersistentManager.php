...
class FPersistentManager
{
    ...
    public function load(int $entityType, int $property, int $id): ?object
    {
        ...
        } else if ($entityType == self::ENTITY_CATEGORIA && $property == self::PROPERTY_DEFAULT) {          //NON DOVREBBE SERVIRE AL CONTROLLO!!
            /*
        ...
        } else if ($entityType == self::ENTITY_CATEGORIA && $property == self::PROPERTY_BY_THREAD) {        //NON DOVREBBE SERVIRE AL CONTROLLO!!
            /*
        ...
        } else if ($entityType == self::ENTITY_MESSAGGIO && $property == self::PROPERTY_DEFAULT) {          //NON DOVREBBE SERIVIRE AL CONTROLLO!!
            /*
             * Restituisce un messaggio dato il suo identificativo.
             */
            $fMessaggio = FMessaggio::getInstance();
            return $fMessaggio->load($id);                                                                  //NON DOVREBBE SERIVRE AL FOUNDATION!!
