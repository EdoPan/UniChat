            ...
            <div class="container-fluid">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/UniChat/categorie/visualizzaCategoria/{$idCategoria}">{$categoriaThread}</a></li>
                ...
                <div class="card shadow mb-2">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="row" style="background-color: #c0c1c8">
                            ...
                            <div>
                                <i class="fa fa-paperclip" style="margin-left: 10px; margin-right: 10px; margin-top: 10px; padding-bottom: 15px" aria-hidden="true"> {$allegato}</i>
...
<!-- Scroll inserisci risposta-->
<a class="scroll-to-top rounded bg-gradient-success " title="Inserisci risposta." href="#inserisci-risposta" style="margin-bottom: 50px">
