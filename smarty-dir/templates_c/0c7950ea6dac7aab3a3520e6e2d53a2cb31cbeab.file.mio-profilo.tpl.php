<?php /* Smarty version Smarty-3.1.13, created on 2021-11-11 13:54:22
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '17333515276189612593d193-55536182',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_618961259c2611_92201128',
  'variables' => 
  array (
    'cate' => 0,
    'c' => 0,
...
<?php if ($_valid && !is_callable('content_618961259c2611_92201128')) {function content_618961259c2611_92201128($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                ...
                <?php if ($_smarty_tpl->tpl_vars['avvisoCampiVuoti']->value==true){?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Avviso. </strong><?php echo $_smarty_tpl->tpl_vars['messaggioAvvisoCampiVuoti']->value;?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['errore']->value==true){?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong>Attenzione. </strong> <?php echo $_smarty_tpl->tpl_vars['messaggioErrore']->value;?>
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-4 mb-xl-0">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <!-- Immagine di profilo-->
                                    <img class="img-account-profile mt-2" src="data:<?php echo $_smarty_tpl->tpl_vars['tipoFotoProfilo']->value;?>
;base64,<?php echo $_smarty_tpl->tpl_vars['immagineFotoProfilo']->value;?>
" style="max-width: 100%">
                        ...
                        <div class="col-xl-8">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h6 class="text-dark mb-4"><?php echo $_smarty_tpl->tpl_vars['cognome']->value;?>
</h6>

                                    <h5 class="text-primary mb-1">Email:</h5>
                                    <h6 class="text-dark mb-4"><?php echo $_smarty_tpl->tpl_vars['email']->value;?>
</h6>

                                    <!-- Contenitore inserimento Corso di Studio -->
                                    <div class="row gx-3 mb-4">
                                        <div class="col-lg">
                                            <h5 class="text-primary" for="inputOrgName">Corso di Studio:</h5>
                                            <input class="form-control" id="inputOrgName" name="nuovoCorsoStudio" type="text" placeholder="Inserisci il nome del corso di studi che frequenti" value="<?php echo $_smarty_tpl->tpl_vars['corsoStudio']->value;?>
">
                                        </div>
                                    </div>
                                    ...
                                    <!-- Contenitore inserimento nuova password -->
                                    <div class="row gx-3 mb-4">
                                        <div class="col-lg">
                                            <h5 class="text-primary" for="password">Password:</h5>
                                            <input class="form-control" id="password" type="password" name="nuovaPassword" placeholder="Inserire una password">
                                        </div>
                                    </div>

                                    <!-- Pulsante salvataggio informazioni -->
                                    <button class="btn btn-primary col-lg" type="submit">Salva modifiche</button>
