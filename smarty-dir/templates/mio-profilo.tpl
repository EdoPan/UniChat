                        ...
                        <div class="col-xl-8">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h6 class="text-dark mb-4">{$cognome}</h6>

                                    <h5 class="text-primary mb-1">Email:</h5>
                                    <h6 class="text-dark mb-4">{$email}</h6>

                                    <!-- Contenitore inserimento Corso di Studio -->
                                    <div class="row gx-3 mb-4">
                                        <div class="col-lg">
                                            <h5 class="text-primary" for="inputOrgName">Corso di Studio:</h5>
                                            <input class="form-control" id="inputOrgName" name="nuovoCorsoStudio" type="text" placeholder="Inserisci il nome del corso di studi che frequenti" value="{$corsoStudio}">
                                        </div>
                                    </div>
